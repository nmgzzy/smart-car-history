...
#define	LCD_PWR(n)		gpio_set(IPS_BL_PIN, n)
#define	LCD_RST(n)		gpio_set(IPS_REST_PIN, n)
#define	LCD_DC(n)		gpio_set(IPS_DC_PIN, n)
#define	LCD_CS(n)		gpio_set(IPS_CS_PIN, n)
