...
void OLED_fill(uint8 x1,uint8 x2,uint8 y,uint8 bmp_data);
...
void OLED_P6x8Str1(uint8 x,uint8 y,uint8 ch[], uint8 num);
void OLED_P8x16Str(uint8 x,uint8 y,uint8 ch[]);
void OLED_HEXACSII(uint16 hex,uint8* Print);
void OLED_HEXACSII1(uint16 hex,uint8* Print);
void OLED_Print_uint16(uint8 x, uint8 y, uint16 num, uint8 have0, uint8 font);
void OLED_Print_int16(uint8 x, uint8 y, int16 num, uint8 have0, uint8 font);
void OLED_Print_float(uint16 x,uint16 y,double dat,uint8 num,uint8 pointnum);
