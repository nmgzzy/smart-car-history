...
void InitMPU6050(void)
{
    ...
    simiic_write_reg(MPU6050_DEV_ADDR, ACCEL_CONFIG, 0x00);    //2g
...
{
    uint8 L;   uint16 H ;
    H=simiic_read_reg(MPU6050_DEV_ADDR, GYRO_YOUT_H, IIC);
    L=simiic_read_reg(MPU6050_DEV_ADDR, GYRO_YOUT_L, IIC);
    mpu_gyro_y = (H<<8)+L;
}
