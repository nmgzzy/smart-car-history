...
void camera_init(void)
{
    ...
    dma_portx2buff_init(DMA_CH0, (void *)&C_IN_DATA(1), (void *)image, C18, DMA_BYTE1, MT9V032_W*MT9V032_H, DADDR_KEEPON);
    ...
    set_irq_priority(PORTC_IRQn,0);                             // 中断优先级
...
void VSYNC(void)
{
	dma_repeat(DMA_CH0,(void *)&C_IN_DATA(1),(void *)image[0],MT9V032_W*MT9V032_H);
}
