...
//------------------------------------以下代码用于PIT中断------------------------------------
#define     pit_get_ms(PITn_e)          pit_time_get(PITn_e) / bus_clk_mhz/1000;
#define     pit_get_us(PITn_e)          pit_time_get(PITn_e) / bus_clk_mhz;
#define     pit_get_ns(PITn_e)           pit_time_get(PITn_e) / bus_clk_mhz * 1000;
